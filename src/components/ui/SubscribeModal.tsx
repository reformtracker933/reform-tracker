...
export default function SubscribeModal({
  ...
  const modalContent = (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-999 flex items-center justify-center p-4 overflow-y-auto'>
      ...
      <div className='relative bg-white rounded-xl border-2 border-neutral-900 shadow-[8px_8px_0px_#1a1a1a] w-full max-w-lg p-8 md:p-10 pt-8 md:pt-8 z-10 my-auto'>
        {status === 'success' ? (
          <>
            <button
              onClick={onClose}
              className='absolute top-5 right-5 w-10 h-10 flex items-center justify-center rounded-lg border-2 border-neutral-900 bg-white shadow-[2px_2px_0px_#1a1a1a] hover:shadow-[3px_3px_0px_#1a1a1a] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all duration-150'
              aria-label='Close'
            >
              <X className='w-5 h-5' />
            </button>
            <div className='text-center py-12'>
              <div className='w-20 h-20 bg-success border-2 border-neutral-900 rounded-xl flex items-center justify-center mx-auto mb-6 shadow-[4px_4px_0px_#1a1a1a]'>
                <svg
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              <div>
                <label
                  htmlFor='email'
                  className='block text-sm font-bold text-neutral-900 mb-2.5'
                >
                ...
                <input
                  ...
                  className='w-full px-5 py-3.5 rounded-xl border-2 border-neutral-900 focus:shadow-[3px_3px_0px_#e63946] shadow-[3px_3px_0px_#1a1a1a] focus:outline-none transition-all duration-150 text-neutral-900 text-base font-medium'
                />
              </div>
