...
export default function Footer() {
  ...
  return (
    <footer className="w-full mt-10">
      <div className="mx-auto bg-[#DADADA] dark:bg-gray-800 rounded-xl py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 ml-28">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="mt-1 text-md text-neutral-600 dark:text-gray-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/dashboard"
                  className="text-neutral-600 dark:text-gray-300 hover:underline"
                >
                  {pageText.dashboard}
                </Link>
              </li>
          ...
          <div>
            <div className="w-[60%]">
              <h4 className="text-xl font-medium text-neutral-900 dark:text-white mb-4">
