...
import Button from '@/components/ui/DashboardReformUpdateButton';
...
const UpdatesSection: FC<{
  ...
  return (
    <section className='w-full py-8 md:py-12'>
      <div className='max-w-7xl mx-auto bg-neutral-100 rounded-xl border-2 border-neutral-900 shadow-[6px_6px_0px_#1a1a1a] px-4 py-6 md:px-6 md:py-8 lg:px-8 lg:py-10'>
        <div className='text-center'>
          <h2 className='text-3xl md:text-5xl lg:text-6xl font-black text-primary mb-3 md:mb-12'>
            {pageText.reformUpdateTitle}
          </h2>
        </div>

        <div className='flex flex-col max-w-4xl mx-auto md:flex-row gap-3 md:gap-4 mb-8 md:mb-12'>
          <div className='relative flex-1'>
            <input
              ...
              className='h-12 md:h-14 w-full pl-10 md:pl-12 pr-4 rounded-xl border-2 border-neutral-900 bg-white text-neutral-900 font-bold text-sm md:text-base shadow-[3px_3px_0px_#1a1a1a] focus:shadow-[4px_4px_0px_#e63946] focus:outline-none transition-all duration-150'
            />
            <Search className='absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 md:h-5 md:w-5 text-neutral-700' />
          </div>
          ...
          <div className='flex gap-3 md:gap-4'>
            <div className='relative flex-1 md:w-34'>
              <select
                ...
                className='appearance-none text-center h-12 md:h-14 rounded-xl border-2 border-neutral-900 bg-white text-neutral-900 font-bold w-full text-sm md:text-base pr-8 shadow-[3px_3px_0px_#1a1a1a] focus:shadow-[4px_4px_0px_#e63946] focus:outline-none transition-all duration-150 cursor-pointer'
              >
            ...
            <div className='relative flex-1 md:w-34'>
              <input
                ...
                className='h-12 md:h-14 rounded-xl border-2 border-neutral-900 bg-white text-neutral-900 font-bold w-full text-sm md:text-base px-4 shadow-[3px_3px_0px_#1a1a1a] focus:shadow-[4px_4px_0px_#e63946] focus:outline-none transition-all duration-150 cursor-pointer'
              />
            </div>
          </div>
        </div>
