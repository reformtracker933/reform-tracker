    ...
    <section className="w-full py-12 dark:bg-gray-900">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        ...
        <div className="w-[60%] md:w-[70%] px-4 flex justify-center mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#E83231] dark:text-white mb-4 leading-tight mt-6 sm:mt-8">
            {pageText.title}
          </h2>
        </div>
        ...
        <div className="w-[64%] flex justify-center mx-auto">
          <p className="text-lg md:text-xl text-neutral-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto font-semibold">
