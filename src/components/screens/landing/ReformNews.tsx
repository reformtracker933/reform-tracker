  ...
  return (
    <section className='w-full py-8 md:py-12 lg:py-16 '>
      <div className='max-w-7xl mx-auto '>
        <h1 className='text-3xl md:text-4xl lg:text-5xl font-black text-primary mb-6 md:mb-8 text-center'>
          {pageText.sectionTitle}
        </h1>

        <div className='flex flex-col lg:flex-row gap-4 md:gap-6 items-stretch justify-center bg-neutral-100 rounded-xl border-2 border-neutral-900 shadow-[6px_6px_0px_#1a1a1a] py-6 px-4 md:px-6 md:py-8 lg:px-8 lg:py-10 w-full'>
