...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-background backdrop-blur-md border-b border-neutral-300 shadow-sm">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="space-y-6 sm:space-y-8">
          {/* Color Palette */}
          <div className="bg-neutral-100 rounded-xl border border-neutral-300 overflow-hidden shadow-sm">
                ...
                <div key={category}>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                    {colorList.map((color) => (
                      <div
                        key={color.var}
                        className="border border-neutral-400 rounded-lg overflow-hidden hover:shadow-md transition-shadow"
                      >
                        <div
          ...
          <div>
            {/* Language Card */}
            <div className="bg-neutral-100 rounded-xl border border-neutral-300 overflow-hidden shadow-sm max-w-2xl mx-auto">
              ...
              <div className="p-4 sm:p-6 space-y-4">
                <div className="p-4 bg-neutral-200 rounded-lg border border-neutral-400 text-center">
          ...
          {/* App State */}
          <div className="bg-neutral-100 rounded-xl border border-neutral-300 overflow-hidden shadow-sm max-w-2xl mx-auto">
            <div className="bg-purple px-4 sm:px-6 py-4 sm:py-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-success text-on-success rounded-lg hover:opacity-90 transition-opacity shadow-md font-medium"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-secondary text-on-secondary rounded-lg hover:opacity-90 transition-opacity shadow-md font-medium"
                  >
          ...
          {/* Locale Formatting */}
          <div className="bg-neutral-100 rounded-xl border border-neutral-300 overflow-hidden shadow-sm">
            <div className="bg-warning px-4 sm:px-6 py-4 sm:py-6">
